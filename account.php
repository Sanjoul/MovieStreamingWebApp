...
session_start();
 ...
 <head>
   ...
   <?php include 'header.php';  ?>
      ...
      <br><br><br><br><br><input type='text' class='form-control' placeholder='Enter full name' name='fname' value='".ucwords($result['name'])."'>
          <br>
          ...
          <input type='text' class='from-control' placeholder='Enter Date of Birth' name='dob' value='".$result['DOB']."'><br>
              ...
              <br><br>
              <label><b>Email Id : </b>".$result['email']."</label></br>
              <label><b>Account Expiration Date : </b>".$result['subscription']."</label>
              <br><br>
